#!/usr/bin/env python3
"""맥부킷 카드 썸네일 생성 — 세로형 1080×1350. ⚠️ 은퇴(2026-08-29).

🔴 **새 글의 대표이미지는 이걸로 만들지 않는다.** 전 채널 공통 1:1 실사 커버로 바뀌었다:
     ~/.claude/skills/image-gen/bin/make-cover
   정본: /Volumes/Samsung X5/Blogs/Blog-strategy/system/cover-image.md
   이 파일은 «옛 글의 플랫 카드»를 다시 뽑아야 할 때만 남겨둔다.
